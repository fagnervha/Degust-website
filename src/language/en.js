export const english = {
    ...
    "No restaurant is available right now": "No restaurant is available right now",
    Email: 'Email',
    Joined: 'Joined',
    ...
    "Want to remove this food your favourite list ?": "Want to remove this food your favourite list ?",
    ...
    "Continue with Facebook": "Continue with Facebook",
    "Don’t worry! Give your registered number & get OTP to update your password.": "Don’t worry! Give your registered number & get OTP to update your password.",
    "GET OTP": "GET OTP",
    "Submit the OTP code sent to your registered phone number and verify": "Submit the OTP code sent to your registered phone number and verify",
    ...
    "Though it is a demo site, our system automatically reset after one hour and that’s why you logged out": "Though it is a demo site, our system automatically reset after one hour and that’s why you logged out",
